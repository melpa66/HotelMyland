...
if ($img !="") {
	...
	if (in_array($extensi, $ekstensi_diperbolehkan) == true) {
		...
		if (!$result) {
			...
			echo "<script>alert('Data berhasil ditambah.');window.location='fasilitas_kamar.php';</script>";
		}
		
	} else {
		echo "<script>alert('Extensi gambar harus png atau jpg.');window.location='fasilitas_kamar.php';</script>";
	}
