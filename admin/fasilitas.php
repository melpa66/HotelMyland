          ...
          <div class="modal-body">
            <form method="post" action="tambah_fasilitas.php" enctype="multipart/form-data">
              <div class="form-group">
                <label>ID</label>
                <input type="text" class="form-control" name="id"  placeholder="ID Kamar" readonly>
              </div>
              <div class="form-group">
                <label>Nama Fasilitas</label>
                <input type="text" class="form-control" name="nama_fasilitas" placeholder="Fasilitas Kamar">
              </div>
              <div class="form-group">
                <label>Image</label>
